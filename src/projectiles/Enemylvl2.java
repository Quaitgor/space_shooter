 ...
 * enemy
 * */
public class Enemylvl2 extends Offensive {
	
	public Enemylvl2(Entity owner, double posX, double posY, double moveX, double moveY, boolean friendOrFoe) {
		super(posX, posY);
		isProjectile = true;
		health = 3;
		hitboxOffset = new int[]{-32, -16, 32, 16};
		mainTexture = new LayerData2(this, "projectile/enemylvl2", 1, 4);
